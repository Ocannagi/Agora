...
ALTER TABLE `tasacioninsitu`
  ...
  ADD KEY `FK_InSituDomicilio` (`tisDomicilioTasacion`);
...
--
ALTER TABLE `tasacioninsitu`
  ADD CONSTRAINT `FK_InSituDomicilio` FOREIGN KEY (`tisDomicilioTasacion`) REFERENCES `domicilio` (`domId`) ON UPDATE CASCADE;
